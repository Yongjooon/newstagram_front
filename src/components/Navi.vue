    ...
    <aside class="sidenav" aria-label="Main navigation">
      <nav class="sidenav__nav">
        ...
        <div class="navgroup">
          ...
          <!-- ✅ 항상 보이도록 조건 제거 -->
          <div class="subnav">
            <!-- ✅ 로딩 중이면 '검색 기록 없음' 대신 로딩 표시 -->
            <div v-if="loadingHistory" class="subnav__empty">
              불러오는 중...
            </div>

            <!-- ✅ 로딩이 끝났는데도 비어있을 때만 '검색 기록 없음' -->
            <div v-else-if="!promptHistory.length" class="subnav__empty">
              검색 기록 없음
            </div>
